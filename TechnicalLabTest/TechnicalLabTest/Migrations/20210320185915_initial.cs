    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalInformationDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonalInformationDetail_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonalInformationDetail_PersonalInformations_PersonalInformationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalInformationDetail_LanguageId",
                table: "PersonalInformationDetail",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalInformationDetail_PersonalInformationId",
                table: "PersonalInformationDetail",
